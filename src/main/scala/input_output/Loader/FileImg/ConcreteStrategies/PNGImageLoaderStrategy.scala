...
/**
 * An image loader strategy specifically for loading PNG images from a file source.
 */
class PNGImageLoaderStrategy extends FileImageLoaderStrategy {
   ...
   *
   * @param source The path to the PNG file.
